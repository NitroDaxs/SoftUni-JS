...
app.put("/jokes/:id", (req, res) => {
  ...
  const joke = jokes.findIndex((joke) => joke.id === jokeId);
  jokes[joke] = replacementJoke;
  res.json(joke);
});
...
app.patch("/jokes/:id", (req, res) => {
  ...
  const seachIndex = jokes.findIndex((joke) => joke.id === id);
  jokes[seachIndex] = replacement;
  console.log(jokes[seachIndex]);
